...
minimum_circle_size = 0  # this is the range of possible circle in pixels you want to find
maximum_circle_size = 5  # maximum possible circle size you're willing to find in pixels
